...
class input {
public:
    static constexpr uint32 MAX_TEXT_INPUT_LENGTH = 512;
    static constexpr uint32 MAX_TEXT_INPUT_COMMAND_LENGTH = 50;
    static constexpr uint32 MAX_TEXT_INPUT_ARGUMENTS_LENGTH =
    ...
    static bool32 is_mouse_button_down(int button);
    static bool32 is_mouse_button_up(int button);
    static bool32 is_mouse_button_now_down(int button);
    static bool32 is_mouse_button_now_up(int button);
    ...
    static void update_text_input(uint32 codepoint);
    static void update_keys(int key, int scancode, int action, int mods);
    static bool32 is_key_down(int key);
    static bool32 is_key_up(int key);
    static bool32 is_key_now_down(int key);
    static bool32 is_key_now_up(int key);
    static bool32 is_mouse_in_bb(v2 topleft, v2 bottomright);
