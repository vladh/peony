namespace util {
  ...
  uint32 kb_to_b(uint32 value) { return value * 1024; }
  uint32 mb_to_b(uint32 value) { return kb_to_b(value) * 1024; }
  uint32 gb_to_b(uint32 value) { return mb_to_b(value) * 1024; }
  uint32 tb_to_b(uint32 value) { return gb_to_b(value) * 1024; }
  real32 b_to_kb(uint32 value) { return value / 1024.0f; }
  real32 b_to_mb(uint32 value) { return b_to_kb(value) / 1024.0f; }
  real32 b_to_gb(uint32 value) { return b_to_mb(value) / 1024.0f; }
  real32 b_to_tb(uint32 value) { return b_to_gb(value) / 1024.0f; }
}
