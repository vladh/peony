...
void peony_parser::get_material_path(char *path, const char *name) {
  strcpy(path, MATERIAL_FILE_DIRECTORY);
  strcat(path, name);
  strcat(path, MATERIAL_FILE_EXTENSION);
}

void peony_parser::print_material_template(MaterialTemplate *material_template) {
...
void peony_parser::print_entity_template(EntityTemplate *entity_template) {
...
void peony_parser::parse_material_file(
...
bool32 peony_parser::parse_scene_file(
  const char *path,
...
void peony_parser::create_material_from_template(
  Material *material,
...
void peony_parser::create_model_loader_from_entity_template(
...
void peony_parser::create_entity_loader_from_entity_template(
  EntityTemplate *entity_template,
  EntityHandle entity_handle,
