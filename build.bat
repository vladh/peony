...
cl %CommonCompilerFlags% ..\src\glad.c ..\src\log.cpp ..\src\shader.cpp ..\src\util.cpp ..\src\camera.cpp ..\src\models.cpp ..\src\asset.cpp ..\src\memory.cpp ..\src\control.cpp ..\src\entity.cpp ..\src\array.cpp ..\src\gl.cpp /link /SUBSYSTEM:console %CommonLinkerFlags% /out:gl.exe
